...
export const MOCK_GO_LINKS: GoLink[] = [
  ...
  },
  {
    ...
    org_id: MOCK_ORGANIZATION.id,
    keyword: 'jira',
    target_url: 'https://acme.atlassian.net/browse/{}',
    default_url: 'https://acme.atlassian.net',
  ...
  },
  {
    ...
    org_id: MOCK_ORGANIZATION.id,
    keyword: 'pr',
    target_url: 'https://github.com/acme-corp/stager/pull/{}',
    default_url: 'https://github.com/acme-corp/stager/pulls',
    description: 'Acme Core Pull Requests by ID',
    click_count: 156,
    created_by: MOCK_PROFILE.id,
    created_at: new Date('2026-02-05T09:30:00Z').toISOString(),
  },
  {
...
export const MOCK_BROADCASTS: Broadcast[] = [
  {
    ...
    author_name: 'David Ortiz',
    author_role: 'Staff SRE',
    poll_options: null,
    is_pinned: true,
    expires_at: new Date(Date.now() + 6 * 3600 * 1000).toISOString(), // Expires in 6 hours
  ...
  },
  {
    ...
    content: 'Join the executive team this **Thursday at 2:00 PM EST** for company-wide updates, product launch showcases, and live Q&A. Remote attendees join via `go/allhands`. Please indicate your attendance format below.',
    department: 'All',
    author_name: 'Elena Rostova',
    author_role: 'Chief of Staff',
    poll_options: ['Attending in Person', 'Joining Remotely', 'Cannot Attend'],
    is_pinned: true,
    expires_at: new Date(Date.now() + 3 * 24 * 3600 * 1000).toISOString(), // Expires in 3 days
    created_at: new Date('2026-09-11T12:00:00Z').toISOString(),
    acknowledged: false,
    read_count: 98,
    total_targeted: 110,
    poll_results: {
      'Attending in Person': 45,
      'Joining Remotely': 48,
      'Cannot Attend': 5,
    },
  },
